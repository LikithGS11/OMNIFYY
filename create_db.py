...
def init_db():
    ...
    try:
        ...
        if cursor.fetchone()[0] == 0:
            # Initial data in IST
            classes_ist = [
                ('Yoga', '2025-06-08 10:00:00', 'Dayana Mam', 5, 5),
                ('Zumba', '2025-06-08 18:00:00', 'Vayun Sir', 8, 8),
                ('HIIT', '2025-06-09 07:00:00', 'Krishna Sir', 10, 10),
                ('Strength Training', '2025-06-10 06:30:00', 'Guna Sir', 2, 2),
                ('Dance Cardio', '2025-06-11 17:00:00', 'Likith Sir', 5, 5),
            ]
